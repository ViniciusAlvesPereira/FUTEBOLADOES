...
#include "playbook_training.h"

QString Playbook_Training::name() {
    return "Playbook_Training";
}

Playbook_Training::Playbook_Training() {
}

int Playbook_Training::maxNumPlayer() {
    return INT_MAX;
}

void Playbook_Training::configure(int numPlayers) {
...
void Playbook_Training::run(int numPlayers) {
